...
class CargasTUG(models.Model):
    ...
    def calculo_tug(self):
        if self.comodo.t_comodo == 'B':
            ...
            tug = 1
        elif self.comodo.t_comodo in ('Q','S','E'):
    ...
    def calculo_pot_tug(self):
        if self.comodo.tug > self.calculo_tug:
            if self.comodo.t_comodo in ('C','B'):
...
class Circuitos(models.Model):
    ...
    ambiente = models.ForeignKey(Local,on_delete=models.CASCADE,related_name='ckt_local')
    tug = models.ManyToManyField(CargasTUG,related_name='ckt_tug',blank=True)
    tue = models.ManyToManyField(CargasTUE,related_name='ckt_tue',blank=True)
    ilum = models.ManyToManyField(CargasILUM,related_name='ckt_ilum',blank=True)
...
class Demandas(models.Model):
    ...
    tue = models.ManyToManyField(CargasTUE, related_name='demanda_tue', blank=True)
    ilum = models.ManyToManyField(CargasILUM, related_name='demanda_ilum', blank=True)
    tug = models.ManyToManyField(CargasTUG, related_name='demanda_tug', blank=True)
